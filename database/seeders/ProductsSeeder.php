    ...
    public function run(): void
    {
        $products = [
            ...
            [
                ...
                'image' => '/images/facilities/induction-melting-furnace.avif',
                'sort_order' => 1,
            ],
            [
                ...
                'image' => '/images/facilities/magnetron-sputtering.avif',
                'sort_order' => 2,
            ],
            // Heat Treatments
            [
                ...
                'image' => '/images/facilities/inert-tube-furnaces.avif',
                'sort_order' => 10,
            ],
            [
                'name' => 'Vacuum Furnace',
                ...
                'image' => '/images/facilities/vacuum-furnace.avif',
                'sort_order' => 11,
            ],
            [
                ...
                'image' => '/images/facilities/burnout-furnace.avif',
                'sort_order' => 12,
            ],
            ...
            [
                ...
                'image' => '/images/facilities/cold-rolling.avif',
                'sort_order' => 20,
            ],
            [
                ...
                'image' => '/images/facilities/multi-directional-forging.avif',
                'sort_order' => 21,
            ],
            // Sample Preparation
            [
                ...
                'image' => '/images/facilities/cutting-wheel-disk.avif',
                'sort_order' => 30,
            ],
            [
                ...
                'image' => '/images/facilities/diamond-wire-saw.avif',
                'sort_order' => 31,
            ],
            [
                ...
                'image' => '/images/facilities/automatic-polishing-machine.avif',
                'sort_order' => 32,
            ],
            [
                ...
                'image' => '/images/facilities/vibro-polishing-machine.avif',
                'sort_order' => 33,
            ],
            ...
            [
                ...
                'image' => '/images/facilities/optical-microscope.avif',
                'sort_order' => 40,
            ],
            [
                ...
                'image' => '/images/facilities/benchtop-sem.avif',
                'sort_order' => 41,
            ],
            [
                ...
                'image' => '/images/facilities/nano-probing.avif',
                'sort_order' => 42,
            ],
            [
                ...
                'image' => '/images/facilities/keithley-devices.avif',
                'sort_order' => 43,
            ],
            [
                ...
                'image' => '/images/facilities/probing-station.avif',
                'sort_order' => 44,
            ],
            [
                'name' => 'Nanoindenter',
                ...
                'image' => '/images/facilities/nanoindenter.avif',
                'sort_order' => 45,
            ],
        ];
